...
impl IrCodeGenerator {
                ...
                Expr::Range(start, end) => {
                    ...
                    elements.push(IrTerm::Assign {
                        ...
                        rhs: Box::new(IrTerm::Call {
                            callee: Box::new(IrTerm::ident("add")),
                            args: vec![IrTerm::ident(ident.as_str()), IrTerm::I32(1)],
                        }),
                    });
                        ...
                        elements: vec![
                            ...
                            IrTerm::While {
                                cond: Box::new(IrTerm::Call {
                                    callee: Box::new(IrTerm::ident("lt")),
                                    args: vec![
                                        IrTerm::ident(ident.as_str()),
    ...
    fn assign(&mut self, lhs: &mut Source<Expr>, rhs: &mut Source<Expr>) -> Result<IrTerm> {
        ...
        match lhs {
            IrTerm::Path(path) => Ok(IrTerm::Assign {
                lhs: path.as_joined_str("_"),
                rhs: Box::new(rhs),
            }),
    ...
    fn expr(&mut self, expr: &mut Source<Expr>) -> Result<IrTerm> {
        match &mut expr.data {
            ...
            Expr::Self_ => Ok(IrTerm::ident("self")),
                ...
                */
                ...
                elements.push(IrTerm::Let {
                    ...
                    value: Box::new(IrTerm::Call {
                        callee: Box::new(IrTerm::ident("alloc")),
            ...
            Expr::Make(type_, _) => match type_ {
                ...
                Type::Vec(type_) => Ok(IrTerm::Call {
                    callee: Box::new(IrTerm::ident("vec_make")),
                    args: vec![
                        IrTerm::i32(5),
                        IrTerm::SizeOf {
                            type_: IrType::from_type(type_)?,
            ...
            Expr::Equal(lhs, rhs) => {
                ...
                Ok(IrTerm::Call {
                    callee: Box::new(IrTerm::ident("equal")),
                    args: vec![lhs, rhs],
                })
            }
            Expr::NotEqual(lhs, rhs) => {
                ...
                Ok(IrTerm::Call {
                    callee: Box::new(IrTerm::ident("not_equal")),
                    args: vec![lhs, rhs],
                })
            }
            Expr::Wrap(expr) => {
